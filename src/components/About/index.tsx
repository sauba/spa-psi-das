...
export default function About() {
  return (
    ...
    >
      ...
      <div>
        <Image src={imgProfile} width={256} height={256} className={`mx-auto rounded-tl-3xl rounded-bl-xl rounded-tr-xl rounded-br-3xl`} priority alt="Psicologa Daniele Andrade" />
      </div>
      <p className={`
            px-3
            pt-8
