...
export default function About() {
  return (
    ...
    >
      ...
      <div>
        <Image src={imgProfile} width={300} height={300} className={`pb-1 rounded-tl-3xl rounded-bl-full rounded-tr-full rounded-br-3xl`} priority alt="Psicologa Daniele Andrade" />
      </div>
      <p className={`
            px-3
            2xl:px-8
