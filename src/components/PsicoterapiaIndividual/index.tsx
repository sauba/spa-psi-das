export default function PsicoterapiaIndividual() {
  return (
    ...
    >
      <div
        className={`text-center mt-72 xl:mt-0 pt-72 xl:pt-0 bg-zinc-900 bg-opacity-90 sm:text-xs md:text-2xl xl:text-4xl tracking-widest font-Shadows-into-light-two`}
      >
        <h1
